...
double simulacion(double x0, double y0, double Vx0, double Vy0, double x0r, double y0r, double Vx0r, double Vy0r, double omega0, double m0, double R0)  {
...
double T = 10, A = 1;
int Ncuadros=100, i; 
double t,tdibujo,dt=1e-3,tmax=10,tcuadro=tmax/Ncuadros; 
